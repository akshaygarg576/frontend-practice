...
5. Append new strong matches to `job-search/applications.md` with status `found` and today's date. Do not duplicate entries already in the tracker.
6. Ask me: "Which of these would you like to apply to?" — wait for my answer before doing anything else.
